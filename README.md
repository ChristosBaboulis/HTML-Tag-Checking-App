...
"test_html_file.html" file must be in same folder with TagMatching.java file -> Go to java files folder through cmd navigation ( cd ) -> javac *.java -> java TagMatching test_html_file.html
